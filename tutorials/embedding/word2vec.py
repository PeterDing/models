...
class Word2Vec(object):
    ...
    def forward(self, examples, labels):
        ...
        emb = tf.Variable(
            tf.random_uniform([opts.vocab_size, opts.emb_dim], -init_width, init_width),
            name="emb")
        self._emb = emb
    ...
    def nce_loss(self, true_logits, sampled_logits):
        ...
        nce_loss_tensor = (
            tf.reduce_sum(true_xent) + tf.reduce_sum(sampled_xent)) / opts.batch_size
    ...
    def optimize(self, loss):
        ...
        train = optimizer.minimize(
            loss, global_step=self.global_step, gate_gradients=optimizer.GATE_NONE)
        self._train = train
