...
def get_model_fn(num_gpus, variable_strategy, num_workers):
    ...
    """
        ...
        with tf.device(consolidation_device):
            ...
            learning_rate = tf.train.piecewise_constant(tf.train.get_global_step(), boundaries,
                                                        staged_lr)
...
def main(job_dir, data_dir, num_gpus, variable_strategy, use_distortion_for_training,
    ...
    # tf.contrib.learn is replace to tf.estimator
